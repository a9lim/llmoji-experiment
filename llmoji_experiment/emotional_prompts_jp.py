...
Run ``python -m interpretability_experiments.kaomoji.emotional_prompts_jp`` to verify pairing
...
def sanity_check() -> None:
    ...
    to match. Run via ``python -m interpretability_experiments.kaomoji.emotional_prompts_jp``.
    """
